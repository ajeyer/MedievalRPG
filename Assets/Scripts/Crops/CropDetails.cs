...
public class CropDetails
{
    ...
    public Season[] seasons; // array to grow particular crops in different seasons ****
    public Sprite harvestedSprite; // sprite used once harvested
    [ItemCodeDescription]
    public int harvestedTransformItemCode; // if the item transforms into another item when harvested this item code will be populated - if harvested item will be used to turn into another *****
   ...
   // public SoundName harvestSound; // the harvest sound for the crop
    ...
    public int xp = 100;  // amount the items xp is worth

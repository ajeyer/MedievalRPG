...
public static class HelperMethods
{
    ...
    /// <summary>
    /// Gets components of type T at box with center point and size and angle. Returns true if at least one found and the found compnents are returned in the list
    /// </summary>
    public static bool GetComponentsAtBoxLocation<T>(out List<T> listComponentsAtBoxPosition, Vector2 point, Vector2 size, float angle)
    {
        ...
        //Loop through all colliders to get an object type T
        for (int i = 0; i < collider2DArray.Length; i++)
        {

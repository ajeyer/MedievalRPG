...
public static class Settings
{
    ...
    //Player Movements
    public const float runningSpeed = 9.33f; // Should be 5.33f for normal running pace
    ...
    //Time System
    public const float secondsPerGameSecond = 0.012f; //Every .7 of a second is an in-game minute
    ...
    static Settings()
    {
        ...
        isPickingRight = Animator.StringToHash("isPickingRight"); //add spaces 

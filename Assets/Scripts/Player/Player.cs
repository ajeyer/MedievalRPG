...
#pragma warning restore 414
    ...
    [Tooltip("Should be populated in the prefab with the eqiupped item sprite renderer")]
    ...
    private void PlayerMovement()
    {
        ...
        ridgidBody2D.MovePosition(ridgidBody2D.position + move);
    }
    ...
    private void ProcessPlayerClickInput(Vector3Int cursorGridPosition, Vector3Int playerGridPosition)
    {
        ...
        //Get Grid property details at cursor positon (th e GridCursor validation routine ensures that grid property details are not null
    ...
    private void ProcessPlayerClickInputSeed(GridPropertyDetails gridPropertyDetails, ItemDetails itemDetails)
    {
        ...
        {
            EventHandler.CallDropSlectedItemEvent();
        }
    }
    ...
    {
        //Only proces if we have cropDetails for the seed
        
        if (GridPropertiesManager.Instance.GetCropDetails(itemDetails.itemCode) != null)
        {

            //Update planted crop at grid property details
   ...
   private IEnumerator WaterGroundAtCursorRoutine(Vector3Int playerDirection, GridPropertyDetails gridPropertyDetails)
    {
        ...
        // Set grid property to watered ground
        GridPropertiesManager.Instance.SetGridPropertyDetails(gridPropertyDetails.gridX, gridPropertyDetails.gridY, gridPropertyDetails);
    ...
    {
        //Vector3 viewport positon for player (0,0) viewport bottom left, (1,1) viewport top right

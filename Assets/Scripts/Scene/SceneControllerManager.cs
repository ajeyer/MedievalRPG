...
public class SceneControllerManager : SingletonMonobehaviour<SceneControllerManager>
{
    ...
    {
        //This is the main external point of contact and influance from the rest of the project
        //This will be called when the plater wants to switch scenes

        //If a fade isnt happening then start fading and switchin scene
        if (!isFading)
        {
